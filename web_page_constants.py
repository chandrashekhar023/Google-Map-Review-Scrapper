    ...
    "review_class": {
        "class":"jJc9Ad", "tag": 'div',
            "outer": {
                    ...
                    "star_class": {"class": "kvMYJc", "tag": 'span', "info_method":"aria-label"},  # span, star info available in aria-label
                    "when_review_time": {"class": "rsqaWe", "tag": 'span', "info_method":"text"},  # span
                    "review_text": {"class": "wiI7pd", "tag": 'span', "info_method":"text"},  # span
                    "review_like_class": {"class": "znYl0", "tag": 'span', "info_method":"text"},  # span
